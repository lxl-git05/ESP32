...
void RGB_LED_Init(void)
{
    gpio_config_t LED_cfg = {
        ...
        .pin_bit_mask = (1ULL << RGB_LED_Y_GPIO_NUM) | (1ULL << RGB_LED_R_GPIO_NUM) | (1ULL << RGB_LED_G_GPIO_NUM),     // GPIO口,需要使用掩码 1ULL << GPIO_NUM_x
...
void RGB_LED_Set(bool is_R_ON , bool is_G_ON ,bool is_Y_ON)
{
    ...
    gpio_set_level(RGB_LED_Y_GPIO_NUM , is_Y_ON) ;
}
